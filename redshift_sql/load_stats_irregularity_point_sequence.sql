...
SELECT etl_run_id,
       (select table_id from etl_waze.DW_TBL_INFO where TABLE_NAME ilike 'irregularity_point_sequence') table_id,
       ...
       FROM dw_waze.stage_irregularity_point_sequence_{{ batchIdValue }} sa
GROUP BY etl_run_id;
