...
DROP TABLE IF EXISTS  {{ dw_schema_name }}.int_jam_point_sequence_{{ batchIdValue }};
CREATE TABLE IF NOT EXISTS {{ dw_schema_name }}.int_jam_point_sequence_{{ batchIdValue }}
(
	jam_id VARCHAR(50)   ENCODE zstd
	,location_x VARCHAR(50)   ENCODE zstd
	,location_y VARCHAR(50)   ENCODE zstd
